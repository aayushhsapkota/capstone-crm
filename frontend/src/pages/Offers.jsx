        ...
        {loading ? (
          ...
          <div className="space-y-2">
            {offers
              ...
              <div
                key={offer.id}
                className="flex flex-col gap-3 border border-slate-200 rounded-lg p-3 bg-white hover:bg-slate-100 transition-colors sm:flex-row sm:items-center sm:justify-between"
              >
